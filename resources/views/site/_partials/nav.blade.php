            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-2 mb-lg-0">
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('inicial') ? 'current' : '' }}" href="{{ route('inicial') }}" style="color:white!important;">Início</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('sobre') ? 'current' : '' }}" href="{{ route('sobre') }}" style="color:white!important;">Sobre</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link {{ request()->routeIs('contato') ? 'current' : '' }}" href="{{ route('contato') }}" style="color:white!important;">Contato</a>
                        </li>
                    </ul>
