    ...
    <section class="pgl-featured">
        <div class="container">
            ...
            <div class="properties-listing">
                <div class="row">
                    <div class="owl-carousel pgl-pro-slide pgl-pro-special"
                         data-plugin-options='{"items": 2, "itemsDesktop": 1, "itemsDesktopSmall": 1, "singleItem": false, "autoPlay": false, "pagination": false, "autoHeight": true}'>
                                        ...
                                        <div class="col-xs-6">
                                            <div class="property-thumb-info">
                                                ...
                                                <div class="amenities clearfix">
                                                    <ul class="pull-left">
                                                        <li><strong><i class="fa fa-arrows"></i></strong>
                                                            450<sup>m2</sup></li>
                                                    </ul>
                                                    <ul class="pull-right">
                        ...
                        <div class="col-xs-6 col-md-3 animation">
                            <a href="{{ route('imovel_show') }}" class="link_preto">
                                <div class="pgl-property">
                                    <div class="property-thumb-info">
                                        <div class="property-thumb-info-image">
                                            <img alt="Imagem propriedade TAL" class="img-responsive"
                                                 src="images/properties/property-1.jpg">
                                            <span class="property-thumb-info-label">
                                            <span class="label price">R$ 358.000,00</span>
                                            <span class="label forrent">Venda</span>
                        ...
                        <div class="row pgl-midnarrow-row">
                            <div class="col-xs-5">
                                <div class="img-thumbnail-medium">
                                    <img src="images/agents/temp-agent.png" class="img-responsive"
                                         alt="Foto Corretor Cléderson de Santi">
                                </div>
                            </div>
                            <div class="col-xs-7">
                                <div class="pgl-agent-info">
                                    <h4>Cléderson de Santi</h4>
                                    <p>FAZER PELO ADMIN.</p>
                                    <address>
                                        <i class="fa fa-whatsapp"></i> <a
                                            href="https://api.whatsapp.com/send?1=pt_BR&phone=5554999750499"
                                            target="_blank">(54) 99975-0499</a> <span class="whats_inicial">Clique para abrir WhatsApp</span><br>
                                        <i class="fa fa-envelope-o"></i> <a href="mailto:cledidesanti@onyline.com.br"
                                                                            target="_blank">cledidesanti@onyline.com.br</a>
                                    </address>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="pgl-agent-item pgl-bg-light">
                        <div class="row pgl-midnarrow-row">
                            <div class="col-xs-5">
                                <div class="img-thumbnail-medium">
                                    <img src="images/agents/temp-agent.png" class="img-responsive"
                                         alt="Foto Corretor Leandro A. Tessaro">
                                </div>
                            </div>
                            <div class="col-xs-7">
                                <div class="pgl-agent-info">
                                    <h4>Leandro A. Tessaro</h4>
                                    <p>FAZER PELO ADMIN.</p>
                                    <address>
                                        <i class="fa fa-whatsapp"></i> <a
                                            href="https://api.whatsapp.com/send?1=pt_BR&phone=5554991768344"
                                            target="_blank">(54) 99176-8344</a> <span class="whats_inicial">Clique para abrir WhatsApp</span><br>
                                        <i class="fa fa-envelope-o"></i> <a href="mailto:leandro@onyline.com.br"
                                                                            target="_blank">leandro@onyline.com.br</a>
                                    </address>
                                </div>
                            </div>
                        </div>
